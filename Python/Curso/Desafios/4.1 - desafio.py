#Desafio 4.1: Faça um programa que leia algo pelo teclado e mostre na tela o seu tipo primitivo e todas as informações possíveis sobre ele de outra forma, utilizando o conceito de {} visto na aula teórica de tipos primitivos print.
